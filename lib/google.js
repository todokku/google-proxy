...
var parseResult = function(body){
    ...
    if(images.length){
        ...
        let injectImgSrcFunc = "function _setImagesSrc(e,c){function f(b){b.onerror=function(){b.style.display=\"none\"};b.src=c}for(var g=0,a=void 0;a=e[g++];){var d=document.getElementById(a)||document.querySelector(\"img[data-iid=\"+a+\"]\");d?f(d):(window.google=window.google||{},google.iir=google.iir||{},google.iir[a]=c)}};";
        ...
        itemList.push({
            ...
            type: "image",
            link: imageLinks,
            script: initialScript + ($(imageScriptSel1).html() || injectImgSrcFunc) + ldiScript.substring(loc.start.column, loc.end.column) + injectScript
        });
    }
